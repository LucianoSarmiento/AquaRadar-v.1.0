...
export const MultiSampleSummary: React.FC<MultiSampleSummaryProps> = ({
  ...
  return (
    <section className="bg-slate-900/70 backdrop-blur-2xl rounded-2xl border border-white/15 p-5 sm:p-6 shadow-2xl shadow-black/40 space-y-6 relative overflow-hidden">
      {/* Decorative Glow */}
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10 border-b border-white/10 pb-4">
        <div className="flex items-center gap-3.5">
          <div className="h-11 w-11 rounded-2xl bg-gradient-to-tr from-blue-600 via-cyan-500 to-teal-400 p-0.5 shadow-lg shadow-cyan-500/25">
            <div className="w-full h-full bg-slate-950 rounded-[14px] flex items-center justify-center">
              <Droplets className="h-5 w-5 text-cyan-300 animate-pulse" />
            </div>
          </div>
          <div>
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-xs font-extrabold flex items-center gap-1.5 transition-all shadow-md active:scale-95 cursor-pointer ${
              maxSamplesReached
          ...
          >
            ...
            <span>{maxSamplesReached ? 'Máx. 10 Muestras' : 'Agregar Muestra'}</span>
          </button>
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-slate-950 text-xs font-extrabold flex items-center gap-1.5 shadow-md shadow-emerald-500/20 border border-emerald-300/40 transition-all active:scale-95 cursor-pointer"
            title="Evaluar todas las muestras ingresadas en un solo clic"
          >
            <Play className="h-3.5 w-3.5 fill-slate-950" />
            <span>Evaluar Todo</span>
          </button>
          ...
          <button
            ...
            className="px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white text-xs font-semibold border border-white/15 transition-all flex items-center gap-1.5 backdrop-blur-md active:scale-95 cursor-pointer shadow-sm"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 relative z-10">
        ...
        <div className="bg-slate-950/60 rounded-2xl p-4 border border-white/10 shadow-lg flex flex-col justify-between">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-black text-white">{totalSamples}</span>
        ...
        <div className="bg-slate-950/60 rounded-2xl p-4 border border-emerald-500/25 shadow-lg flex flex-col justify-between">
          <div className="text-emerald-400 text-xs font-medium flex items-center justify-between">
            <span>Muestras Conformes</span>
        ...
        <div className="bg-slate-950/60 rounded-2xl p-4 border border-rose-500/25 shadow-lg flex flex-col justify-between">
          <div className="text-rose-400 text-xs font-medium flex items-center justify-between">
            <span>Con Transgresiones</span>
        ...
        <div className="bg-slate-950/60 rounded-2xl p-4 border border-cyan-500/25 shadow-lg flex flex-col justify-between">
          <div className="text-cyan-300 text-xs font-medium flex items-center justify-between">
